...
import com.wo.springboot2.util.AnimeCreator;
import com.wo.springboot2.util.AnimePostRequestBodyCreator;
import com.wo.springboot2.util.AnimePutRequestBodyCreator;
...
class AnimeServiceTest {
    ...
    void findByIdOrThrowBadRequestException_BadRequestException_WhenNotFound() {
        BDDMockito.when(animeRepositoryMock.findById(ArgumentMatchers.anyLong()))
    ...
    @Test
    @DisplayName("findByName returns empty list of anime not found")
